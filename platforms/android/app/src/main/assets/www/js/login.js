window.onload = function(){
			$("body").css("padding-top",window.screen.availHeight/6+"px");
			$("body").css("background-image","url(images/backgroud_login.jpg)");
			...
			$("#forgetPassword").on("tap",function(){
				var forgetPassword = mui.openWindow({
